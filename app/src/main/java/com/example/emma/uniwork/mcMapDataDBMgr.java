...
//This class gets the data from the database

public class mcMapDataDBMgr extends SQLiteOpenHelper {

    private static final int DB_VER = 1;
    private static final String DB_PATH = "/data/data/com.example.emma.uniwork/databases/";
    ...
    //This makes a database and adds the EK map database contents to it
    public void dbCreate() throws IOException {

        //This uses the result of the method dbCheck() to determine if the database already exists
        ...
        if(!dbExist){
            ...
            try {
                ...
                //this method is what adds the contents of the database to the newly created empty one
                copyDBFromAssets();
    ...
    private boolean dbCheck(){
        ...
        //tries to open the database to see if it's there already
        try{
    ...
    //This method adds the entries from the database to a variable that can handle them
    ...
    //This looks for a specific database entry
    ...
    //This deletes a specific database entry
    ...
    //This puts all the info from the database into a list that goes to the mapData class that is accessed by the map activity class
